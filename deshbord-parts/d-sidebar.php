<div x-data="{toggleMenu: false}">
    <div class="w-64 min-h-screen bg-blue-900 relative transition-all duration-1000"
        ...
        <div class="flex flex-col flex-grow border-r border-gray-200 pt-5 pb-4">
                ...
                <nav class="flex-1 px-2 space-y-8" aria-label="Sidebar">
                    <div class="space-y-1">
                        ...
                        <a href="#" class=" text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md"
                            ...
                            <svg class="text-white mr-3 flex-shrink-0 h-6 w-6" x-state:on="Current"
                                x-state:off="Default"
                        ...
                        <a href="#"
                            class="text-white hover:bg-blue-800 group flex items-center px-2 py-2 text-sm font-medium rounded-md"
                            x-state-description="undefined: &quot;bg-gray-100 text-gray-900&quot;, undefined: &quot;text-gray-600 hover:bg-gray-50 hover:text-gray-900&quot;">
                            <svg class="text-white mr-3 flex-shrink-0 h-6 w-6"
                    ...
                    <div class="space-y-1">
                        ...
                        <div class="space-y-1" role="group" aria-labelledby="projects-headline">
                            ...
                            <a href="#"
                                class="group flex items-center px-3 py-2 text-sm font-medium text-gray-300 rounded-md hover:text-gray-900 hover:bg-gray-50">
                                <span class="truncate">
                                    Website redesign
                                </span>
                            </a>
