...
<div class="grid grid-cols-1 xl:grid-cols-2 gap-6 max-w-[1400px] mx-auto px-4 py-6">
                ...
                <div class="p-5 md:p-6 flex flex-col justify-between flex-1">
                    <div>
                        <div class="flex justify-between items-start mb-2">
                            <h2
                                class="text-xl font-bold text-gray-900 line-clamp-1 group-hover:text-green-600 transition-colors">
    ...
    <?php
        ...
        echo "<div class='col-span-full text-center p-12 bg-white rounded-2xl border-2 border-dashed border-green-100 text-green-600'>No properties listed yet.</div>";
    }
    $conn->close();
    ?>
